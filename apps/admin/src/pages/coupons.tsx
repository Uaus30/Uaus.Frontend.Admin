      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Códigos de desconto do panfleto: valor, vigência e teto de resgates. O balcão aplica pelo código;
            o histórico de cada venda guarda o cupom como ele era no dia.
          </p>
        </div>
