        ...
        <>
          ...
          <div className="grid items-start gap-3 xl:grid-cols-[1.15fr_1fr]">
            ...
            <AbcMatrix
              ...
              selected={
                tela.focus.tipo === "celula" ? { receita: tela.focus.receita, lucro: tela.focus.lucro } : null
              }
          ...
          <p className="mt-2 border-t border-dashed border-border pt-4 text-xs leading-relaxed text-muted-foreground">
            <strong className="text-foreground/80">Como a curva é montada</strong> — os produtos são ordenados
            por {criterio.toLowerCase()} e o acumulado é somado linha a linha:{" "}
            ...
            pela OUTRA medida — é o cruzamento da matriz. Prejuízo entra como zero na curva de lucro, senão o
            acumulado andaria para trás e a classe deixaria de acompanhar a ordem. A coluna{" "}
